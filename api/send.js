...
export default async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const token = "8194199819:AAGM3WP0SOOTJ8cpb5KBUQa17KtdTbglylA"; // Replace with your actual bot token
    const chatIds = ["6987171667", "6919959944"]; // Replace with your actual chat IDs
